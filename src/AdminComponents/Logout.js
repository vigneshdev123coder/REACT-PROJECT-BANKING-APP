...
import bankingimage from "./banking-image.png";
  ...
  const register = (type) => {
    ...
    if (accounts.some((acc) => acc.email === data.email)) {
      setMessage(
        ...
        } already registered! Click Sign In.`
      );
      return;
    }
  ...
  return (
    <div style={styles.wrapper}>
      <div style={styles.container}>
        ...
        <button style={styles.guestButton} onClick={guestLogin}>
          Guest Login
        </button>
        ...
        <p style={styles.signInText}>
          ...
          <span
            onClick={() =>
              navigate(activeForm === "admin" ? "/login" : "/loginuser")
            }
            style={styles.link}
          >
            Sign In
